%==============================================
% WorldTheory.pl for actor qahttpclient
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqahttpclient).	%%old version (deprecated)
actorobj(qatuqahttpclient).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qahttpclient
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qahttpclient" ). 
