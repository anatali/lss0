...
public abstract class AbstractQafilewatcher extends QActor { 
		...
		*/    
	    ...
	    StateFun handleToutBuiltIn = () -> {	
	    	try{	
	    		...
	    		println( "qafilewatcher tout : stops");  
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	parg = "watchFileInDir(\"./sharedFiles\")"; 
	    	actorOpExecute(parg, false);	//OCT17		 
	    	repeatPlanNoTransition(pr,myselfName,"qafilewatcher_"+myselfName,true,false);
