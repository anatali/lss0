%==============================================
% WorldTheory.pl for actor qabls0client
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqabls0client).	%%old version (deprecated)
actorobj(qatuqabls0client).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qabls0client
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qabls0client" ). 
...
%-------------------------------------------------
%  User static rules about qabls0client
%------------------------------------------------- 
/*
------------------------------------------------------------------------
