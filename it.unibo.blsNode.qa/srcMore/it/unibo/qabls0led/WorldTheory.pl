%==============================================
% WorldTheory.pl for actor qabls0led
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqabls0led).	%%old version (deprecated)
actorobj(qatuqabls0led).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qabls0led
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qabls0led" ). 
...
%-------------------------------------------------
%  User static rules about qabls0led
%------------------------------------------------- 
/*
------------------------------------------------------------------------
