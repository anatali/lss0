%==============================================
% WorldTheory.pl for actor cmdemitter
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatucmdemitter).	%%old version (deprecated)
actorobj(qatucmdemitter).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor cmdemitter
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of cmdemitter" ). 
...
%-------------------------------------------------
%  User static rules about cmdemitter
%------------------------------------------------- 
/*
------------------------------------------------------------------------
