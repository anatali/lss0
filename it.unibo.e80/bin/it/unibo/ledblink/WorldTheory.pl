%==============================================
% WorldTheory.pl for actor ledblink
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuledblink).	%%old version (deprecated)
actorobj(qatuledblink).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor ledblink
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of ledblink" ). 
...
%-------------------------------------------------
%  User static rules about ledblink
%------------------------------------------------- 
/*
------------------------------------------------------------------------
