%==============================================
% WorldTheory.pl for actor qatester
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqatester).	%%old version (deprecated)
actorobj(qatuqatester).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qatester
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qatester" ). 
...
%-------------------------------------------------
%  User static rules about qatester
%------------------------------------------------- 
p( 80,0).
p( 80,30).
p( 30,50).
