...
public class DeviceLedImpl extends SituatedPlainObject implements IDeviceLedImpl{
...
//	}
	...
	@Override
 	public String getDefaultRep() { 		
 		String ledLedColor = color==LedColor.RED ? "RED" : "GREEN";
   		return "device(led("+this.name+")," + color + ","+ isOn() +")";
 	}
	@Override
