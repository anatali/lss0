%==============================================
% WorldTheory.pl for actor ledgpio
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuledgpio).	%%old version (deprecated)
actorobj(qatuledgpio).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor ledgpio
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of ledgpio" ). 
...
%-------------------------------------------------
%  User static rules about ledgpio
%------------------------------------------------- 
/*
------------------------------------------------------------------------
