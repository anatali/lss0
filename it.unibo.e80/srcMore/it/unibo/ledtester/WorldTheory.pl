%==============================================
% WorldTheory.pl for actor ledtester
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuledtester).	%%old version (deprecated)
actorobj(qatuledtester).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor ledtester
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of ledtester" ). 
...
%-------------------------------------------------
%  User static rules about ledtester
%------------------------------------------------- 
/*
------------------------------------------------------------------------
