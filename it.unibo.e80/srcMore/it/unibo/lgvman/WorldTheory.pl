%==============================================
% WorldTheory.pl for actor lgvman
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatulgvman).	%%old version (deprecated)
actorobj(qatulgvman).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor lgvman
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of lgvman" ). 
...
%-------------------------------------------------
%  User static rules about lgvman
%------------------------------------------------- 
/*
------------------------------------------------------------------------
