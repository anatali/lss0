%==============================================
% WorldTheory.pl for actor lgvtester
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatulgvtester).	%%old version (deprecated)
actorobj(qatulgvtester).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor lgvtester
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of lgvtester" ). 
...
%-------------------------------------------------
%  User static rules about lgvtester
%------------------------------------------------- 
/*
------------------------------------------------------------------------
