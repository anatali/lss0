%==============================================
% WorldTheory.pl for actor lgvtester1
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatulgvtester1).	%%old version (deprecated)
actorobj(qatulgvtester1).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor lgvtester1
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of lgvtester1" ). 
...
%-------------------------------------------------
%  User static rules about lgvtester1
%------------------------------------------------- 
/*
------------------------------------------------------------------------
