%==============================================
% WorldTheory.pl for actor qacontrol
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqacontrol).	%%old version (deprecated)
actorobj(qatuqacontrol).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qacontrol
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qacontrol" ). 
