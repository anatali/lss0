%==============================================
% WorldTheory.pl for actor smarttm
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusmarttm).	%%old version (deprecated)
actorobj(qatusmarttm).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor smarttm
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of smarttm" ). 
...
%-------------------------------------------------
%  User static rules about smarttm
%------------------------------------------------- 
lgvStatus( lgv,free).
