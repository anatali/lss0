%==============================================
% WorldTheory.pl for actor sourcehandler
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusourcehandler).	%%old version (deprecated)
actorobj(qatusourcehandler).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor sourcehandler
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of sourcehandler" ). 
...
%-------------------------------------------------
%  User static rules about sourcehandler
%------------------------------------------------- 
/*
------------------------------------------------------------------------
