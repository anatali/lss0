%==============================================
% WorldTheory.pl for actor wharehouse
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuwharehouse).	%%old version (deprecated)
actorobj(qatuwharehouse).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor wharehouse
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of wharehouse" ). 
...
%-------------------------------------------------
%  User static rules about wharehouse
%------------------------------------------------- 
cell( c1,free).
cell( c2,free).
/*
