%==============================================
% WorldTheory.pl for actor sonardetector
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusonardetector).	%%old version (deprecated)
actorobj(qatusonardetector).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor sonardetector
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of sonardetector" ). 
...
%-------------------------------------------------
%  User static rules about sonardetector
%------------------------------------------------- 
/*
------------------------------------------------------------------------
