%==============================================
% WorldTheory.pl for actor qambotpc
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqambotpc).	%%old version (deprecated)
actorobj(qatuqambotpc).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qambotpc
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qambotpc" ). 
...
%-------------------------------------------------
%  User static rules about qambotpc
%------------------------------------------------- 
/*
------------------------------------------------------------------------
