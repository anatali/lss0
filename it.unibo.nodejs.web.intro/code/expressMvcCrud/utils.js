...
exports.requestUtil = function(req,res,cb){
var urlParts    = url.parse(req.url, true),
	urlParams   = urlParts.query, 
	urlPathname = urlParts.pathname,
	body = '',
	reqInfo = {};
	//console.log("requestUtil="+urlPathname  + " " + req.body );
...
exports.doAnswerStr = function(err, response, answer){  //answer: a string  ;
  	if( err ){	response.statusCode=500; response.end(answer); }
  	else { response.statusCode=200; response.end(answer); }
}
exports.doAnswerApi = function(status, response, jsonData){   
