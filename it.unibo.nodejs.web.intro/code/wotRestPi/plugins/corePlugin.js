...
CorePlugin.prototype.simulate = function () {
   ...
   //by AN : activating ALL the simulation
  var self = this;
...
CorePlugin.prototype.observeActions = function () {
  ...
  _.forEach(self.actions, function (actionId) { //#F
  	console.log("OBSERVE ACTION %s : %s" , actionId , resources.links.actions.resources[actionId] );
  	//console.log("OBSERVE self.doAction %s " , self.doAction );
   /*
   //ORIGINAL
