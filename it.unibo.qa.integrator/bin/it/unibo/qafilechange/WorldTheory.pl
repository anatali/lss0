%==============================================
% WorldTheory.pl for actor qafilechange
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqafilechange).	%%old version (deprecated)
actorobj(qatuqafilechange).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qafilechange
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qafilechange" ). 
...
%-------------------------------------------------
%  User static rules about qafilechange
%------------------------------------------------- 
/*
------------------------------------------------------------------------
