%==============================================
% WorldTheory.pl for actor rovermqtt
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturovermqtt).	%%old version (deprecated)
actorobj(qaturovermqtt).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor rovermqtt
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of rovermqtt" ). 
...
%-------------------------------------------------
%  User static rules about rovermqtt
%------------------------------------------------- 
