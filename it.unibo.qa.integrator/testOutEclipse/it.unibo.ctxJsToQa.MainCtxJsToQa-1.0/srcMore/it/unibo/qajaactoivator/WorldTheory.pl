%==============================================
% WorldTheory.pl for actor qajaactoivator
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqajaactoivator).	%%old version (deprecated)
actorobj(qatuqajaactoivator).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qajaactoivator
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qajaactoivator" ). 
...
%-------------------------------------------------
%  User static rules about qajaactoivator
%------------------------------------------------- 
/*
------------------------------------------------------------------------
