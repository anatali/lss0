%==============================================
% WorldTheory.pl for actor musicreactiveasycnh
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatumusicreactiveasycnh).	%%old version (deprecated)
actorobj(qatumusicreactiveasycnh).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor musicreactiveasycnh
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of musicreactiveasycnh" ). 
...
%-------------------------------------------------
%  User static rules about musicreactiveasycnh
%------------------------------------------------- 
/*
------------------------------------------------------------------------
