%==============================================
% WorldTheory.pl for actor qacontrolhl
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqacontrolhl).	%%old version (deprecated)
actorobj(qatuqacontrolhl).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qacontrolhl
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qacontrolhl" ). 
