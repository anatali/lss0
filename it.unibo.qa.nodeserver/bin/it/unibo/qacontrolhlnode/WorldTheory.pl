%==============================================
% WorldTheory.pl for actor qacontrolhlnode
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqacontrolhlnode).	%%old version (deprecated)
actorobj(qatuqacontrolhlnode).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qacontrolhlnode
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qacontrolhlnode" ). 
...
%-------------------------------------------------
%  User static rules about qacontrolhlnode
%------------------------------------------------- 
/*
------------------------------------------------------------------------
