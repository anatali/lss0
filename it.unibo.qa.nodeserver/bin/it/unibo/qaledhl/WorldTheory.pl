%==============================================
% WorldTheory.pl for actor qaledhl
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqaledhl).	%%old version (deprecated)
actorobj(qatuqaledhl).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qaledhl
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qaledhl" ). 
...
%-------------------------------------------------
%  User static rules about qaledhl
%------------------------------------------------- 
/*
------------------------------------------------------------------------
