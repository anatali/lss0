%==============================================
% WorldTheory.pl for actor qaledhlcustom
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqaledhlcustom).	%%old version (deprecated)
actorobj(qatuqaledhlcustom).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qaledhlcustom
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qaledhlcustom" ). 
...
%-------------------------------------------------
%  User static rules about qaledhlcustom
%------------------------------------------------- 
/*
------------------------------------------------------------------------
