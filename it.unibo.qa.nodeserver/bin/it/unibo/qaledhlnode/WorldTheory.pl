%==============================================
% WorldTheory.pl for actor qaledhlnode
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqaledhlnode).	%%old version (deprecated)
actorobj(qatuqaledhlnode).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qaledhlnode
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qaledhlnode" ). 
...
%-------------------------------------------------
%  User static rules about qaledhlnode
%------------------------------------------------- 
config( led,nodePc).
value( "1").
value( "2").
