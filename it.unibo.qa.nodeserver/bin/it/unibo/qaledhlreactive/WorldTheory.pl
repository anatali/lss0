%==============================================
% WorldTheory.pl for actor qaledhlreactive
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqaledhlreactive).	%%old version (deprecated)
actorobj(qatuqaledhlreactive).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qaledhlreactive
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qaledhlreactive" ). 
...
%-------------------------------------------------
%  User static rules about qaledhlreactive
%------------------------------------------------- 
config( led,gui).
/*
------------------------------------------------------------------------
