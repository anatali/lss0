%==============================================
% WorldTheory.pl for actor qamqttreceivet
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqamqttreceivet).	%%old version (deprecated)
actorobj(qatuqamqttreceivet).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qamqttreceivet
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qamqttreceivet" ). 
...
%-------------------------------------------------
%  User static rules about qamqttreceivet
%------------------------------------------------- 
/*
------------------------------------------------------------------------
