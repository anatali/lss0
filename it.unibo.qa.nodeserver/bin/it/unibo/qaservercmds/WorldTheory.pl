%==============================================
% WorldTheory.pl for actor qaservercmds
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqaservercmds).	%%old version (deprecated)
actorobj(qatuqaservercmds).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qaservercmds
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qaservercmds" ). 
...
%-------------------------------------------------
%  User static rules about qaservercmds
%------------------------------------------------- 
/*
------------------------------------------------------------------------
