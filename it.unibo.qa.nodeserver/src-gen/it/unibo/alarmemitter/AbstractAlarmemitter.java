...
public abstract class AbstractAlarmemitter extends QActor { 
		...
		*/    
	    ...
	    StateFun handleToutBuiltIn = () -> {	
	    	try{	
	    		...
	    		println( "alarmemitter tout : stops");  
