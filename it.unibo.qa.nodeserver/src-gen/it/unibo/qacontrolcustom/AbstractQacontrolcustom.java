...
public abstract class AbstractQacontrolcustom extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractQacontrolcustom(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/qacontrolcustom/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");		
			this.planFilePath = "./srcMore/it/unibo/qacontrolcustom/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    StateFun handleToutBuiltIn = () -> {	
	    	try{	
	    		...
	    		println( "qacontrolcustom tout : stops");  
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	temporaryStr = "\"BUTTON WAITS\"";
	    	println( temporaryStr );  
	    	//bbb
	     msgTransition( pr,myselfName,"qacontrolcustom_"+myselfName,false,
	          new StateFun[]{
	          ...
	          try{
	            ...
	            //ActionSwitch for a message or event
	             if( currentEvent.getMsg().startsWith("clicked") ){
	            	...
	            	if( parg != null ) sendMsg("turn","qaledcustom", QActorContext.dispatch, parg ); 
	             }
