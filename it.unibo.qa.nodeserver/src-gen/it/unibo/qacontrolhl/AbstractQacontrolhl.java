...
public abstract class AbstractQacontrolhl extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractQacontrolhl(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/qacontrolhl/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");		
			this.planFilePath = "./srcMore/it/unibo/qacontrolhl/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    StateFun handleToutBuiltIn = () -> {	
	    	try{	
	    		...
	    		println( "qacontrolhl tout : stops");  
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	//bbb
	     msgTransition( pr,myselfName,"qacontrolhl_"+myselfName,false,
	          new StateFun[]{
