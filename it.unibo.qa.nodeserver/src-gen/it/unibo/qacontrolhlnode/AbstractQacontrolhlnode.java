...
public abstract class AbstractQacontrolhlnode extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractQacontrolhlnode(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/qacontrolhlnode/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");		
			this.planFilePath = "./srcMore/it/unibo/qacontrolhlnode/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    StateFun handleToutBuiltIn = () -> {	
	    	try{	
	    		...
	    		println( "qacontrolhlnode tout : stops");  
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("init",-1);
	        ...
	        switchToPlanAsNextState(pr, myselfName, "qacontrolhlnode_"+myselfName, 
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	//bbb
	     msgTransition( pr,myselfName,"qacontrolhlnode_"+myselfName,false,
	          new StateFun[]{
	          ...
	          try{
	            ...
	            //ActionSwitch for a message or event
	             if( currentEvent.getMsg().startsWith("clicked") ){
	            	String parg="switch(N)";
	            	/* SendDispatch */
	            	parg = updateVars(Term.createTerm("clicked(N)"),  Term.createTerm("clicked(N)"), 
	            		    		  					Term.createTerm(currentEvent.getMsg()), parg);
	            	if( parg != null ) sendMsg("turn","qaledhlnode", QActorContext.dispatch, parg ); 
	             }
