%==============================================
% WorldTheory.pl for actor qacontrolhlblinkreactive
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqacontrolhlblinkreactive).	%%old version (deprecated)
actorobj(qatuqacontrolhlblinkreactive).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qacontrolhlblinkreactive
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qacontrolhlblinkreactive" ). 
...
%-------------------------------------------------
%  User static rules about qacontrolhlblinkreactive
%------------------------------------------------- 
/*
------------------------------------------------------------------------
