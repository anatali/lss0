%==============================================
% WorldTheory.pl for actor alarmemitter
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatualarmemitter).	%%old version (deprecated)
actorobj(qatualarmemitter).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor alarmemitter
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of alarmemitter" ). 
...
%-------------------------------------------------
%  User static rules about alarmemitter
%------------------------------------------------- 
/*
------------------------------------------------------------------------
