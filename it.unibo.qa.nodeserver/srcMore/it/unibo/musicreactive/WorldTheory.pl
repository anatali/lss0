%==============================================
% WorldTheory.pl for actor musicreactive
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatumusicreactive).	%%old version (deprecated)
actorobj(qatumusicreactive).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor musicreactive
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of musicreactive" ). 
...
%-------------------------------------------------
%  User static rules about musicreactive
%------------------------------------------------- 
/*
------------------------------------------------------------------------
