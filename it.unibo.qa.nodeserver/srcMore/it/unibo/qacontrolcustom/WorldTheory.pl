%==============================================
% WorldTheory.pl for actor qacontrolcustom
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqacontrolcustom).	%%old version (deprecated)
actorobj(qatuqacontrolcustom).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qacontrolcustom
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qacontrolcustom" ). 
...
%-------------------------------------------------
%  User static rules about qacontrolcustom
%------------------------------------------------- 
config( button,gui).
/*
------------------------------------------------------------------------
