%==============================================
% WorldTheory.pl for actor qacontrolhlcustom
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqacontrolhlcustom).	%%old version (deprecated)
actorobj(qatuqacontrolhlcustom).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qacontrolhlcustom
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qacontrolhlcustom" ). 
...
%-------------------------------------------------
%  User static rules about qacontrolhlcustom
%------------------------------------------------- 
/*
------------------------------------------------------------------------
