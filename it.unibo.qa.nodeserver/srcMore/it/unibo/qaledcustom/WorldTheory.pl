%==============================================
% WorldTheory.pl for actor qaledcustom
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqaledcustom).	%%old version (deprecated)
actorobj(qatuqaledcustom).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qaledcustom
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qaledcustom" ). 
...
%-------------------------------------------------
%  User static rules about qaledcustom
%------------------------------------------------- 
config( led,gui).
/*
------------------------------------------------------------------------
