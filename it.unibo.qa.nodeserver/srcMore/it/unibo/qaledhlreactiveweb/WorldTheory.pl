%==============================================
% WorldTheory.pl for actor qaledhlreactiveweb
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqaledhlreactiveweb).	%%old version (deprecated)
actorobj(qatuqaledhlreactiveweb).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qaledhlreactiveweb
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qaledhlreactiveweb" ). 
...
%-------------------------------------------------
%  User static rules about qaledhlreactiveweb
%------------------------------------------------- 
config( led,gui).
/*
------------------------------------------------------------------------
