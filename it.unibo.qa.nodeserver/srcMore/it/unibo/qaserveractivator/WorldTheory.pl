%==============================================
% WorldTheory.pl for actor qaserveractivator
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqaserveractivator).	%%old version (deprecated)
actorobj(qatuqaserveractivator).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qaserveractivator
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qaserveractivator" ). 
...
%-------------------------------------------------
%  User static rules about qaserveractivator
%------------------------------------------------- 
/*
------------------------------------------------------------------------
