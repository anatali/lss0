...
import it.unibo.ctxBlsHl.MainCtxBlsHl;
...
public class TestBlsHl {
   ...
   private String ledState;
	...
	public void setUp() throws Exception  {
    	ctx = MainCtxBlsHl.initTheContext();
    	...
    	//each actor has terminated its initialization phase
   		while( control == null || led == null ){
   			//wait for creation
  	 		Thread.sleep(100);  
 			control  = QActorUtils.getQActor("qacontrolhl_ctrl");
  			led      = QActorUtils.getQActor("qaledhl_ctrl");
  		};
